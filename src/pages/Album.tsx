      ...
      <div className='flex w-full gap-8'>
        <div className='flex-none w-1/4 flex flex-col items-center gap-2'>
          <div className='w-full rounded-[8px] shadow-[0_5px_8px_0_rgba(0, 0, 0, .2)] relative group cursor-pointer overflow-hidden'>
            <div
              className={`invisible group-hover:visible rounded-[8px] z-10 w-full h-full absolute top-0 left-0 bg-[rgba(0,0,0,0.5)]`}
            ></div>
            <img
            ...
            {isPlaying ? (
              <span
                ...
                className={`visible group-hover:visible z-20 absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center text-white hover:opacity-0.8`}
              >
                {isPlaying ? (
                  <span
              ...
              <span
                ...
                className={`invisible group-hover:visible z-20 absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center text-white hover:opacity-0.8`}
              >
                <IoPlayCircleOutline size={50} />
              </span>
            )}
                  ...
                  <Flowbite key={item.id} theme={{ theme: customTooltip }}>
                    ...
                    >
                      <span
                        ...
                        className='cursor-pointer hover:underline relative hover:text-[#0f7070]'
                      >
        ...
        <div className='px-5 h-[500px] w-full overflow-y-scroll'>
